...
myApp.controller('controller', ["$scope", "$http" , function($scope,$http) {
    ...
    $scope.abouts=[
    {
        ...
        description:'Транспортная компания «СЕВЕР ЭКСПРЕСС» профессионально занимается'
                    ...
                    +' Наши машины оперативно перевезут Ваш груз в Ханты-Мансийский Автономный округ или любую другую точку России. Заранее'
                    ...
                    +' можно меньше, понимая, что если наше сотрудничество будет Вам экономически'
                    +' выгодно, то выиграем, в конечном счете, мы сами. Четкость нашей работы'
